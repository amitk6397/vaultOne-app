...
enum VideoStorage { local, database }
...
class DeviceVideoFolder {
  ...
  bool get hasNewVideos => isNew || newVideoCount > 0;
}
...
class MediaSecuritySettings {
  const MediaSecuritySettings({
    ...
    this.photoBiometricsEnabled = true,
    this.videoBiometricsEnabled = true,
  ...
  final bool photoBiometricsEnabled;
  final bool videoBiometricsEnabled;
  ...
  MediaSecuritySettings copyWith({
    bool? pinEnabled,
    bool? photoBiometricsEnabled,
    bool? videoBiometricsEnabled,
    ...
    return MediaSecuritySettings(
      ...
      photoBiometricsEnabled:
          photoBiometricsEnabled ?? this.photoBiometricsEnabled,
      videoBiometricsEnabled:
          videoBiometricsEnabled ?? this.videoBiometricsEnabled,
