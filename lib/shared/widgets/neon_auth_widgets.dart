        ...
        children: [
          if (glass)
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: const Color(0xFF6FB9FF).withValues(alpha: 0.55),
                ),
                boxShadow: [
                  BoxShadow(
                    color: const Color(0xFF2D8CFF).withValues(alpha: 0.45),
                    blurRadius: 30,
                  ),
                  BoxShadow(
                    color: const Color(0xFF8B2DFF).withValues(alpha: 0.22),
                    blurRadius: 40,
          ...
          ShaderMask(
            shaderCallback: (rect) => const LinearGradient(
              colors: [Color(0xFF20D6FF), Color(0xFF9C34FF)],
              begin: Alignment.topLeft,
              end: Alignment.bottomRight,
            ).createShader(rect),
            child: Icon(
          ...
          Text(
            ...
            style: TextStyle(
              ...
              height: 1,
              shadows: const [Shadow(color: Color(0xFF29D9FF), blurRadius: 12)],
            ),
          ),
          Positioned(
            bottom: size * 0.30,
